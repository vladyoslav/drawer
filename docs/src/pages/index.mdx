...
<div className="flex flex-col text-center gap-2 items-center p-8">
  <span className="text-lg">And that's not all the features! Check out the docs for more info!</span>
  <Button asChild>
    <Link href="/docs">
      Read the Docs
    </Link>
